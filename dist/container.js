...
export class Container {
    ...
    static register(service, factory) {
        ...
        this.providers.set(service, () => this.serve(factory !== null && factory !== void 0 ? factory : service));
    }
    /**
     ...
     */
    static resolve(service, fresh = false) {
 ...
 * @private
 */
Container.providers = new WeakMap();
/**
 ...
 */
export function app(service, fresh = false) {
